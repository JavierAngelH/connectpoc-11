...
@ToString
@EqualsAndHashCode
public class FacsprestoCd4Control {
    @Id
    ...
    private Double expCd4Lower;

    private Double expCd4Upper;

    private Double expPercentCd4Lower;

    private Double expPercentCd4Upper;

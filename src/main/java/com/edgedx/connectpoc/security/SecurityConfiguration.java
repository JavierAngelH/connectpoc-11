...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	private static final String LOGOUT_SUCCESS_URL = "/" + ViewsConstants.PAGE_DASHBOARD;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable()
				...
				.anyRequest().hasAnyAuthority(new String[]{"ROLE_SYSTEM", "ROLE_USER", "ROLE_VIEWER"})

				// Configure the login page.
				.and().formLogin().loginPage(LOGIN_URL).permitAll().loginProcessingUrl(LOGIN_PROCESSING_URL)
				.failureUrl(LOGIN_FAILURE_URL).successForwardUrl(LOGOUT_SUCCESS_URL)
